...
router.post("/:problemId/create-upvote", verifyToken, createUpvote).get("/:problemId/upvotes",getAllUpvotes);
router.get("/upvotes/upvoteId",getUpvote).delete("/:problemId/remove-upvote", verifyToken, removeUpvote);
