...
router.post("/:solutionId/create-upvote", verifyToken, createUpvote).get("/:solutionId/upvotes",getAllUpvotes);
router.get("/upvotes/upvoteId",getUpvote).delete("/:solutionId/remove-upvote", verifyToken, removeUpvote);
